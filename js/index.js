...
// Add this to your existing JavaScript file (index.js)
document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleScrollAnimation() {
        const skillsSection = document.querySelector('#about-skills-context .sec-context-inner');
        if (skillsSection && isInViewport(skillsSection) && !skillsSection.classList.contains('appear')) {
            skillsSection.classList.add('appear');
            
            // Add staggered animation to skill icons
    ...
    // Initialize skill icons for animation
    const skillIcons = document.querySelectorAll('.skill-icon');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    GitHubCalendar(".calendar", "DaffaIkhwan", {
        responsive: true,
        tooltips: true,
        global_stats: false,
        summary_text: '',
...
document.addEventListener('DOMContentLoaded', function() {
    // Initialize intersection observer for title animations
    ...
    // Observe all split-line-up-effect elements
    document.querySelectorAll('.split-line-up-effect').forEach(element => {
        observer.observe(element);
    });
});

document.addEventListener('DOMContentLoaded', function() {
    // Force show the skills title
    const skillsTitle = document.querySelector('#featured-title');
    if (skillsTitle) {
        skillsTitle.style.opacity = '1';
        const innerText = skillsTitle.querySelector('.split-line-inner');
        if (innerText) {
